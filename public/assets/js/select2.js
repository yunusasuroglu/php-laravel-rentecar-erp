(function () {
    ...
    /* templating selection with images */
    function selectClient (client) {
        ...
        var baseUrl = "./assets/images/faces/select2/";
        var $client = $(
          '<span><img alt=""  /> <span></span></span>'
        );
      
        // Use .text() instead of HTML string concatenation to avoid script injection issues
        $client.find("span").text(client.text);
        $client.find("img").attr("src", baseUrl + "/" + client.element.value.toLowerCase() + ".jpg");

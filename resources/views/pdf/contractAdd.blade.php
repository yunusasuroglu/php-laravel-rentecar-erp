    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <ul>
                ...
                <li><strong>Cars:</strong> {{ $carData["car"]["brand"] }} {{ $carData["car"]["model"] }} ({{ $carData["number_plate"] }})</li>
            ...
            <p>Für weitere Informationen oder Änderungen an Ihrer Buchung, besuchen Sie bitte unser oder kontaktieren Sie unseren Kundenservice unter <a href="mailto:info@jet-cars.com">info@jet-cars.com</a>.</p>

														...
														<tr>
															<td class="pad">
																<div class="alignment" align="center" style="line-height:10px">
																	<div style="max-width: 300px;"><a href="#" target="_blank" style="outline:none" tabindex="-1"><img src="https://52f4dea81b.imgdist.com/pub/bfra/oziej1k4/rul/rwh/s20/logo.svg" style="display: block; height: auto; border: 0; width: 100%;" width="300" alt="Logo" title="Logo" height="auto"></a></div>
																</div>
															</td>
														</tr>
													</table>
														...
														<tr>
															<td class="pad" style="padding-bottom:5px;padding-left:10px;padding-right:10px;padding-top:10px;">
																<div style="color:#B1AED1;font-family:'Nunito', Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:20px;line-height:120%;text-align:center;mso-line-height-alt:24px;">
																	<p style="margin: 0; word-break: break-word;"><span>{{$user->name}} {{$user->surname}} Ihr Konto wird derzeit überprüft</span></p>
																</div>
															</td>
														</tr>
													</table>
														...
														<tr>
															<td class="pad" style="padding-bottom:5px;padding-left:5px;padding-right:5px;">
																<div style="color:#454562;font-family:'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:38px;line-height:120%;text-align:center;mso-line-height-alt:45.6px;">
																	<p style="margin: 0; word-break: break-word;"><span>Ihre Kontoinformationen werden überprüft</span></p>
																</div>
															</td>
														</tr>
													</table>
														...
														<tr>
															<td class="pad" style="padding-bottom:10px;padding-left:25px;padding-right:25px;padding-top:10px;">
																<div style="color:#555555;font-family:'Nunito', Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:14px;line-height:150%;text-align:center;mso-line-height-alt:21px;">
																	<p style="margin: 0; word-break: break-word;">Ihre Kontoinformationen werden überprüft. Das Unternehmen, das zu dem Firmencode gehört, den Sie bei der Registrierung verwendet haben, ist {{$company->name}}. Ihr Konto wird genehmigt, wenn der Unternehmensmanager Ihr Konto genehmigt. Für detaillierte Informationen können Sie sich an Ihren Unternehmensleiter wenden.</p>
																</div>
															</td>
														</tr>
													</table>
													<table class="image_block block-4" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
														<tr>
															<td class="pad" style="padding-top:15px;width:100%;padding-right:0px;padding-left:0px;">
																<div class="alignment" align="center" style="line-height:10px">
																	<div class="fullWidth" style="max-width: 501.5px;"><img src="https://52f4dea81b.imgdist.com/pub/bfra/oziej1k4/kj8/75o/cyd/happy-tiny-people-near-huge-welcome-word-flat-illustration_74855-10808.jpg" style="display: block; height: auto; border: 0; width: 100%;" width="501.5" alt="I'm an image" title="I'm an image" height="auto"></div>
																</div>
															</td>
														</tr>
													</table>
